...
public class IdrPsiEscapedNameIdImpl extends ASTWrapperPsiElement implements IdrPsiEscapedNameId {

  public IdrPsiEscapedNameIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdrPsiVisitor visitor) {
    visitor.visitEscapedNameId(this);
  }
