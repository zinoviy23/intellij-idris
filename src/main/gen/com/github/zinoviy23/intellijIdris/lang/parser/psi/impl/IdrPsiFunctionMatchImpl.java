...
public class IdrPsiFunctionMatchImpl extends ASTWrapperPsiElement implements IdrPsiFunctionMatch {

  public IdrPsiFunctionMatchImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdrPsiVisitor visitor) {
    visitor.visitFunctionMatch(this);
  }
  ...
  @Override
  @NotNull
  public List<IdrPsiPattern> getPatternList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdrPsiPattern.class);
  }
