...
public class IdrPsiTypeExpressionImpl extends IdrPsiExpressionImpl implements IdrPsiTypeExpression {

  public IdrPsiTypeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
