...
public class IdrPsiLetExpressionImpl extends IdrPsiExpressionImpl implements IdrPsiLetExpression {

  public IdrPsiLetExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdrPsiLetEntry> getLetEntryList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdrPsiLetEntry.class);
  }
