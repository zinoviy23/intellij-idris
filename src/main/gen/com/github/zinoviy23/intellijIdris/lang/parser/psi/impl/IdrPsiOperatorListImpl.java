...
public class IdrPsiOperatorListImpl extends ASTWrapperPsiElement implements IdrPsiOperatorList {

  public IdrPsiOperatorListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdrPsiVisitor visitor) {
    visitor.visitOperatorList(this);
  }
