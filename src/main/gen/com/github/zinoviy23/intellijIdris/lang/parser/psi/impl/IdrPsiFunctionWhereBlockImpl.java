...
public class IdrPsiFunctionWhereBlockImpl extends ASTWrapperPsiElement implements IdrPsiFunctionWhereBlock {

  public IdrPsiFunctionWhereBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdrPsiVisitor visitor) {
    visitor.visitFunctionWhereBlock(this);
  }
