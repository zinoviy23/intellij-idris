...
public class IdrPsiInterfaceArgumentImpl extends ASTWrapperPsiElement implements IdrPsiInterfaceArgument {

  public IdrPsiInterfaceArgumentImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdrPsiVisitor visitor) {
    visitor.visitInterfaceArgument(this);
  }
