...
public class IdrPsiIdentificatorReferenceImpl extends ASTWrapperPsiElement implements IdrPsiIdentificatorReference {

  public IdrPsiIdentificatorReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdrPsiVisitor visitor) {
    visitor.visitIdentificatorReference(this);
  }
