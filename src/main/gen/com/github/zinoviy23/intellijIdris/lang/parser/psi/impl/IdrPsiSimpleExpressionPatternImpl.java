...
public class IdrPsiSimpleExpressionPatternImpl extends IdrPsiPatternImpl implements IdrPsiSimpleExpressionPattern {

  public IdrPsiSimpleExpressionPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull IdrPsiVisitor visitor) {
    visitor.visitSimpleExpressionPattern(this);
  }
  ...
  public IdrPsiSimpleExpression getSimpleExpression() {
    return findNotNullChildByClass(IdrPsiSimpleExpression.class);
  }
