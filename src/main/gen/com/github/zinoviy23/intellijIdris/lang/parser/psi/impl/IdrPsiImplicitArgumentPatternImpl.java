...
public class IdrPsiImplicitArgumentPatternImpl extends IdrPsiPatternImpl implements IdrPsiImplicitArgumentPattern {

  public IdrPsiImplicitArgumentPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull IdrPsiVisitor visitor) {
    visitor.visitImplicitArgumentPattern(this);
  }
