...
public class IdrPsiEmptyTupleParenExpressionImpl extends IdrPsiParenExpressionImpl implements IdrPsiEmptyTupleParenExpression {

  public IdrPsiEmptyTupleParenExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull IdrPsiVisitor visitor) {
    visitor.visitEmptyTupleParenExpression(this);
  }
